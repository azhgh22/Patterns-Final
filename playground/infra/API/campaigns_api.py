...
from playground.core.services.interfaces.service_interfaces.repository_chooser_interface import IRepositoryChooser
from playground.core.services.interfaces.service_interfaces.service_chooser_interface import IServiceChooser
...
@campaigns_api.post("")
async def create_campaign(request: Request, campaign_type: str, params: Dict[str, Any]) -> Campaign:
    service = get_campaign_service(request)
    return service.create(service.get_campaign_request_with_type_instance(campaign_type, **params))
